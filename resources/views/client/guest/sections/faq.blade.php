<section id="event"
    ...
    <div class="px-6 w-full max-w-screen-xl py-16 lg:py-30 text-center">
        <h1 class="md:mb-4 text-3xl font-semibold tracking-wide text-white lg:px-12 md:text-6xl 2xl:text-7xl">FAQ</h1>
        <div id="accordion-flush mt-10" data-accordion="collapse"
            ...
            <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                <div class="py-5 border-b border-gray-200 text-start">
                    ...
                    <p class="text-gray-500">Check out this guide to learn how to <a
                            ...
                            class="text-blue-600">get started</a> and start
            ...
            <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
                <div class="py-5 border-b border-gray-200 text-start">
                    ...
                    <p class="text-gray-500">Check out the <a href="https://flowbite.com/figma/"
                            class="text-blue-600 hover:underline">Figma design system</a> based on
            ...
            <h2 id="accordion-flush-heading-3">
                <button type="button"
                    ...
                    <span class="text-start">What are the differences between Flowbite and Tailwind UI?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
