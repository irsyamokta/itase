        ...
        <div class="p-6 bg-white rounded-md shadow-md border-2 border-accent">
            ...
            <div class="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-10 gap-6">
                ...
                <div class="items-center gap-2">
                    <label for="imageUpload">
                        <div id="banner-preview"
                            class="max-w-xs w-24 h-32 bg-gray-200 rounded-md flex items-center justify-center overflow-hidden border-2 border-gray-400 hover:border-purple-500">
                ...
                <div class="md:col-span-7 lg:col-span-9 space-y-4">
                    <input type="number" min="0" placeholder="Harga event" name="price" value="{{ $event->price }}" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500" />
                    <textarea name="description" cols="5" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
