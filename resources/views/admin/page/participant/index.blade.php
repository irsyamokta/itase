...
@section('content')
    <section x-data="{ page: 'participant', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
            ...
            <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
                ...
                <main>
                    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-5">
                        @include('admin.components.table.participant')
                    </div>
                </main>
            </div>
        </div>
