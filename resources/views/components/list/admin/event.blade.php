<li>
    <a href="{{ route('dashboard.event') }}"
        ...
        @click="selected = (selected === 'Event' ? '':'Event')" :class="page.includes('event') ? 'bg-secondary' : ''">
        <svg fill="#ffffff" width="18" height="18" viewBox="0 0 122.88 122.88" id="Layer_1" data-name="Layer 1"
